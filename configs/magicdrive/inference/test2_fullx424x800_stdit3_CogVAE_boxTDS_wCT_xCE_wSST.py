...
# Dataset settings
num_frames = 65 #'full'  1/9/17/33/65/129/full...(8n+1)
...
dataset_cfg_overrides = (
    ...
    ("+dataset.data.val.info_file_from_planner", '/mnt/projects/MagicDrive-V2/info_10.json'),
)
#info_file_from_planner = '/mnt/projects/MagicDrive-V2/info_10.json'
...
# Log settings
seed = 42
outputs = "outputs/test/CogVAE-424"
wandb = False
epochs = 150
log_every = 1
ckpt_every = 500 * 5
