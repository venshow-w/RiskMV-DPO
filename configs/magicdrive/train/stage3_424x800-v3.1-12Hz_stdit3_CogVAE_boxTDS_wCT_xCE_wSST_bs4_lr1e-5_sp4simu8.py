...
dataset_cfg_overrides = [
    ...
    (
        ...
        ("dataset.data.train.video_length", video_lengths_fps["424x800"][0]), # 424x800
        ("dataset.data.train.fps", video_lengths_fps["424x800"][1]),  # 424x800
        ("+dataset.data.train.repeat_times", video_lengths_fps["424x800"][2]),  # 424x800
        ("+dataset.data.train.balance_keywords", balance_keywords),  # 424x800
        ("dataset.data.val.video_length", video_lengths_fps["424x800"][0]), # 424x800
        ("dataset.data.val.fps", video_lengths_fps["424x800"][1]), # 424x800
...
load = None
# load='/media/omnisky/12dd907f-8a2c-4a49-954c-a33edc979c06/pretrained/magicdrive/MagicDriveDiT-stage3-40k-ft'
grad_clip = 1.0
lr = 8e-5
ema_decay = 0.99
adam_eps = 1e-15
