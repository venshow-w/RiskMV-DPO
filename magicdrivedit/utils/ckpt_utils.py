...
def load(
    ...
    if optimizer is not None and os.path.exists(os.path.join(load_dir, "optimizer")):
        try:
    ...
    if lr_scheduler is not None and os.path.exists(os.path.join(load_dir, "lr_scheduler")):
        booster.load_lr_scheduler(lr_scheduler, os.path.join(load_dir, "lr_scheduler"))
    if sampler is not None and os.path.exists(os.path.join(load_dir, "sampler")):
