...
def parse_args(training=False):
    ...
    parser.add_argument("config", 
        # default='/mnt/projects/MagicDrive-V2/configs/magicdrive/train/stage4_higher-b-v3.1-12Hz_stdit3_CogVAE_boxTDS_wCT_xCE_wSST_bs4_lr1e-5_sp4simu8_gen3c.py',
    ...
    parser.add_argument(
        "--ckpt-path",
        default ='/media/omnisky/12dd907f-8a2c-4a49-954c-a33edc979c06/pretrained/magicdrive/MagicDriveDiT-stage3-40k-ft',
        # default='model.from_pretrained=/media/omnisky/12dd907f-8a2c-4a49-954c-a33edc979c06/pretrained/magicdrive/MagicDriveDiT-stage3-40k-ft',
        type=str,
