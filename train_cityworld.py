...
from worldcache.cityworld.transformers_GS import LatentRecon
...
def main():
    ...
    # +++++++++++++++ recon +++++++++++++++
    config = OmegaConf.load('worldcache/cityworld/configs/default.yaml')
        ...
        with tqdm(
            ...
            for step, batch in pbar:
                ...
                with timers["move_data"] as move_data_t:
                    ...
                    first_frame =  batch.pop("first_frame")
                ...
                with timers["move_data2"] as move_data_t:
                    ...
                    model_args['first_frame'] = first_frame
