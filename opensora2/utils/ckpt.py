...
#  替代 tensornvme，零依赖、零报错、兼容 CUDA12.4
import asyncio
import aiofiles

class AsyncFileWriter:
    def __init__(self, filepath, block_size=None):
        self.filepath = filepath
        self.fp = None

    async def open(self):
        self.fp = await aiofiles.open(self.filepath, 'wb')
